...
To use an existing channel instead of building one, see [Channels](./code-channels.md). Telegram, Discord, and fakechat are included in the research preview.
...
* [Channels](./code-channels.md) to install and use Telegram, Discord, or the fakechat demo, and to enable channels for a Team or Enterprise org

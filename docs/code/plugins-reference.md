...
<Tip>
  For hands-on tutorials and practical usage, see [Plugins](./plugins.md). For plugin management across teams and communities, see [Plugin marketplaces](./plugin-marketplaces.md).
</Tip>
...
For complete details on plugin command structure, invocation patterns, and features, see [Plugin commands](./slash-commands.md#plugin-commands).

...
<Tabs>
  <Tab title="CLAUDE.md">
    ...
    **Inheritance:** Claude reads CLAUDE.md files from your working directory up to the root, and discovers nested ones in subdirectories as it accesses those files. See [How Claude looks up memories](./code-memory.md#how-claude-looks-up-memories) for details.

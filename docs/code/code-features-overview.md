...
<Tabs>
  ...
  <Tab title="CLAUDE.md vs Skill">
    ...
    **Rule of thumb:** Keep CLAUDE.md under 200 lines. If it's growing, move reference content to skills or split into [`.claude/rules/`](./code-memory.md#organize-rules-with-clauderules) files.
  </Tab>

...
<Tabs>
  ...
  <Tab title="Hooks">
    **When:** On trigger. Hooks can run before or after tool executions, at session start, before compaction, and at other lifecycle events. See [Hooks](./code-hooks.md) for the full list.

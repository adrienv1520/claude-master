...
<Tabs>
  ...
  <Tab title="MCP servers">
    ...
    **Context cost:** [Tool search](./code-mcp.md#scale-with-mcp-tool-search) (enabled by default) loads MCP tools up to 10% of context and defers the rest until needed.

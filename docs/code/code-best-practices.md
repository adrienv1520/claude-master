...
Alternatively, use `--dangerously-skip-permissions` to bypass permission prompts for contained workflows like fixing lint errors or generating boilerplate. See [permission modes](./code-permissions.md#permission-modes) for what is and isn't skipped.
...
Read more about [configuring permissions](./code-permissions.md) and [enabling sandboxing](./code-sandboxing.md).

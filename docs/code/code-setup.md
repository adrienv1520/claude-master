...
3. **Enterprise platforms**: Configure Claude Code to use [Amazon Bedrock, Google Vertex AI, or Microsoft Foundry](./code-third-party-integrations.md) for enterprise deployments with your existing cloud infrastructure.

<Note>
  Claude Code securely stores your credentials. See [Credential Management](./code-iam.md#credential-management) for details.
</Note>
...
If you encounter any issues during installation, consult the [troubleshooting guide](./code-troubleshooting.md#linux-permission-issues).
...
For details on running Claude Code on AWS or GCP, see [third-party integrations](./code-third-party-integrations.md).

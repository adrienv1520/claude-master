...
If you encounter any issues during installation, consult the [troubleshooting guide](./code-troubleshooting.md).
...
3. **Cloud providers**: Configure Claude Code to use [Amazon Bedrock, Google Vertex AI, or Microsoft Foundry](./code-third-party-integrations.md) for deployments with your existing cloud infrastructure.
...
<Warning>
  ...
  If you encounter permission errors, see [troubleshooting permission errors](./code-troubleshooting.md#command-not-found-claude-or-permission-errors) for recommended solutions.
</Warning>
...
* WSL 2 supports [sandboxing](./code-sandboxing.md) for enhanced security. WSL 1 does not support sandboxing.
...
Set the `DISABLE_AUTOUPDATER` environment variable in your shell or [settings.json file](./code-settings.md):

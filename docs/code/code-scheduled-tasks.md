...
Tasks are session-scoped: they live in the current Claude Code process and are gone when you exit. For durable scheduling that survives restarts, use [Cloud](./code-web-scheduled-tasks.md) or [Desktop](./code-desktop.md#schedule-recurring-tasks) scheduled tasks, or [GitHub Actions](./code-github-actions.md).
...
* [Desktop scheduled tasks](./code-desktop.md#schedule-recurring-tasks): run locally on your machine

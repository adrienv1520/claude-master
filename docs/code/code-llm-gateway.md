...
If you have configured custom model names in your gateway, use the environment variables documented in [Model configuration](./code-model-config.md) to match your custom names.
...
* [Enterprise network configuration](./code-network-config.md)
* [Third-party integrations overview](./code-third-party-integrations.md)

...
| ---------------------- | ------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| **Toggle shortcut**    | Press `Option+T` (macOS) or `Alt+T` (Windows/Linux)                                  | Toggle thinking on/off for the current session. May require [terminal configuration](./code-terminal-config.md) to enable Option key shortcuts |
...
| **Limit token budget** | Set [`MAX_THINKING_TOKENS`](./code-settings.md#environment-variables) environment variable | Limit the thinking budget to a specific number of tokens. Example: `export MAX_THINKING_TOKENS=10000`                                    |
...
* Use the [`MAX_THINKING_TOKENS` environment variable](./code-settings.md#environment-variables) to cap the thinking budget

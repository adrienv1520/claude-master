...
For the full reference, see the [Skills documentation](./code-skills.md).
...
<Tip>
  Skills can be scoped to a project, personal directory, or organization. They can also accept arguments with `$ARGUMENTS`. See the [Skills documentation](./code-skills.md) for details.
</Tip>

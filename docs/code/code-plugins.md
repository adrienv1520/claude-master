...
<Steps>
  ...
  <Step title="Add slash command arguments">
    ...
    Claude will greet you by name. For more argument options like `$1`, `$2` for individual parameters, see [Slash commands](./code-slash-commands.md).
  </Step>
</Steps>
...
* Dive deeper into specific plugin components:
  * [Slash commands](./code-slash-commands.md): command development details
  * [Subagents](./code-sub-agents.md): agent configuration and capabilities
  * [Agent Skills](./code-skills.md): extend Claude's capabilities

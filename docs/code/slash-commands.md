...
| `/permissions`            | View or update [permissions](./iam.md#configuring-permissions)                                                               |
...
Include file contents in commands using the `@` prefix to [reference files](./common-workflows.md#reference-files-and-directories).
...
Wildcards aren't supported in [permissions for MCP tools](./iam.md#tool-specific-permission-rules).

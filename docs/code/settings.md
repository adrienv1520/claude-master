...
* Enterprise deployments can also configure **managed MCP servers** that override
  user-configured servers. See [Enterprise MCP configuration](./mcp.md#enterprise-mcp-configuration):
...
| `disableBypassPermissionsMode` | Set to `"disable"` to prevent `bypassPermissions` mode from being activated. This disables the `--dangerously-skip-permissions` command-line flag. See [managed policy settings](./iam.md#enterprise-managed-policy-settings)                                                                | `"disable"`                                                            |
...
* [IAM and access control](./iam.md#enterprise-managed-policy-settings) - Enterprise policy management

...
When spawning a teammate, you can reference a [subagent](./code-sub-agents.md) type from any [subagent scope](./code-sub-agents.md#choose-the-subagent-scope): project, user, plugin, or CLI-defined. This lets you define a role once, such as a security-reviewer or test-runner, and reuse it both as a delegated subagent and as an agent team teammate.

...
These changes apply to the [local project level](./code-settings.md) and are saved in
...
### Output Styles vs. [Agents](./code-sub-agents.md)
...
### Output Styles vs. [Skills](./code-skills.md)

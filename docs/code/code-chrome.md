...
* [Claude Code CLI](./code-quickstart.md#step-1-install-claude-code) version 2.0.73 or higher
...
<Steps>
  <Step title="Update Claude Code">
    Chrome integration requires a recent version of Claude Code. If you installed using the [native installer](./code-quickstart.md#step-1-install-claude-code), updates happen automatically. Otherwise, run:

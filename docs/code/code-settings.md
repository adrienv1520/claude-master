...
| `hooks`                      | Configure custom commands to run before or after tool executions. See [hooks documentation](./code-hooks.md)                                                                                                                                                                          | `{"PreToolUse": {"Bash": "echo 'Running command...'"}}`                 |
...
See [SessionStart hooks](./code-hooks.md#persisting-environment-variables) for more details on Option 3.

...
| `alwaysThinkingEnabled`      | Enable [extended thinking](./code-common-workflows.md#use-extended-thinking) by default for all sessions. Typically configured via the `/config` command rather than editing directly                                                                                                 | `true`                                                                  |
...
| `SLASH_COMMAND_TOOL_CHAR_BUDGET`              | Maximum number of characters for slash command metadata shown to the [Skill tool](./code-slash-commands.md#skill-tool) (default: 15000)                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| **Skill**           | Executes a [skill or slash command](./code-slash-commands.md#skill-tool) within the main conversation    | Yes                 |
...
* [Troubleshooting](./code-troubleshooting.md#auto-updater-issues) - Solutions for common configuration issues

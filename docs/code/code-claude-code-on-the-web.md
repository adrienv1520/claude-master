...
Configure automatic dependency installation using [SessionStart hooks](./code-hooks.md#sessionstart). This can be configured in your repository's `.claude/settings.json` file:

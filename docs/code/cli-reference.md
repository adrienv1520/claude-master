...
| `--allowedTools`                 | A list of tools that should be allowed without prompting the user for permission, in addition to [settings.json files](./settings.md)                                                                    | `"Bash(git log:*)" "Bash(git diff:*)" "Read"`                                                      |
...
| `--disallowedTools`              | A list of tools that should be disallowed without prompting the user for permission, in addition to [settings.json files](./settings.md)                                                                 | `"Bash(git log:*)" "Bash(git diff:*)" "Edit"`                                                      |
...
| `--permission-mode`              | Begin in a specified [permission mode](./iam.md#permission-modes)                                                                                                                                        | `claude --permission-mode plan`                                                                    |

...
* Set `"fastMode": true` in your [user settings file](./code-settings.md)
...
You can combine both: use fast mode with a lower [effort level](./code-model-config.md#adjust-effort-level) for maximum speed on straightforward tasks.
...
* [Model configuration](./code-model-config.md): switch models and adjust effort levels
* [Manage costs effectively](./code-costs.md): track token usage and reduce costs
* [Status line configuration](./code-statusline.md): display model and context information

...
* Cannot read files that are denied in your [Claude permission settings](./code-iam.md#configuring-permissions)
...
* **IAM policies**: Combine with [permission settings](./code-iam.md) for defense-in-depth

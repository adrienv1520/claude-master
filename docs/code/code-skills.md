...
| :--------- | :---------------------------------------------------------- | :-------------------------------- |
| Enterprise | See [managed settings](./code-iam.md#enterprise-managed-settings) | All users in your organization    |
...
[Subagents](./code-sub-agents.md) do not automatically inherit Skills from the main conversation. To give a custom subagent access to specific Skills, list them in the subagent's `skills` field in `.claude/agents/`:
...
* **Enterprise**: Administrators can deploy Skills organization-wide through [managed settings](./code-iam.md#enterprise-managed-settings). See [Where Skills live](#where-skills-live) for enterprise Skill paths.

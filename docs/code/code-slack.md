...
| Claude Code on the web | Access to [Claude Code on the web](./code-claude-code-on-the-web.md) must be enabled |
...
automatically visible to the organization. See [Claude Code on the Web sharing](./code-claude-code-on-the-web.md#sharing-sessions)
for more details.

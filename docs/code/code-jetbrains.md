...
If you haven't installed Claude Code yet, see [our quickstart guide](./code-quickstart.md) for installation instructions.
...
<Warning>
  WSL users may need additional configuration for IDE detection to work properly. See our [WSL troubleshooting guide](./code-troubleshooting.md#jetbrains-ide-not-detected-on-wsl2) for detailed setup instructions.
</Warning>
...
* For WSL users, see the [WSL troubleshooting guide](./code-troubleshooting.md#jetbrains-ide-not-detected-on-wsl2)
...
For additional help, see our [troubleshooting guide](./code-troubleshooting.md).

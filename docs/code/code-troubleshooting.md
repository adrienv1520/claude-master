...
| `managed-settings.json`       | [Managed settings](./code-settings.md#settings-files)          |
...
Then set `USE_BUILTIN_RIPGREP=0` in your [environment](./code-settings.md#environment-variables).
...
For additional JetBrains configuration tips, see our [JetBrains IDE guide](./code-jetbrains.md#plugin-settings).

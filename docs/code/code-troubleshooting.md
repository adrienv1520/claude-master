...
2. **Use post-processing hooks**: Set up automatic formatting hooks to detect and add missing language tags. See the [markdown formatting hook example](./code-hooks-guide.md#markdown-formatting-hook) for implementation details.

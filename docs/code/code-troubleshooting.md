...
| `managed-settings.json`       | [Enterprise managed settings](./code-settings.md#settings-files)             |
| `managed-mcp.json`            | [Enterprise managed MCP servers](./code-mcp.md#enterprise-mcp-configuration) |

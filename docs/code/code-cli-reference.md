...
| `claude agents`                 | List all configured [subagents](./code-sub-agents.md), grouped by source | `claude agents`                                   |
| `claude mcp`                    | Configure Model Context Protocol (MCP) servers                     | See the [Claude Code MCP documentation](./code-mcp.md). |
...
| `--agents`                             | Define custom [subagents](./code-sub-agents.md) dynamically via JSON (see below for format)                                                                                                                     | `claude --agents '{"reviewer":{"description":"Reviews code","prompt":"You are a code reviewer"}}'` |
...
| `--allowedTools`                       | Tools that execute without prompting for permission. See [permission rule syntax](./code-settings.md#permission-rule-syntax) for pattern matching. To restrict which tools are available, use `--tools` instead | `"Bash(git log *)" "Bash(git diff *)" "Read"`                                                      |
...
| `--chrome`                             | Enable [Chrome browser integration](./code-chrome.md) for web automation and testing                                                                                                                            | `claude --chrome`                                                                                  |
...
| `--no-chrome`                          | Disable [Chrome browser integration](./code-chrome.md) for this session                                                                                                                                         | `claude --no-chrome`                                                                               |
...
| `--permission-mode`                    | Begin in a specified [permission mode](./code-permissions.md#permission-modes)                                                                                                                                  | `claude --permission-mode plan`                                                                    |
...
| `--remote`                             | Create a new [web session](./code-claude-code-on-the-web.md) on claude.ai with the provided task description                                                                                                    | `claude --remote "Fix the login bug"`                                                              |
...
| `--teleport`                           | Resume a [web session](./code-claude-code-on-the-web.md) in your local terminal                                                                                                                                 | `claude --teleport`                                                                                |
| `--teammate-mode`                      | Set how [agent team](./code-agent-teams.md) teammates display: `auto` (default), `in-process`, or `tmux`. See [set up agent teams](./code-agent-teams.md#set-up-agent-teams)                                          | `claude --teammate-mode in-process`                                                                |
...
| `--worktree`, `-w`                     | Start Claude in an isolated [git worktree](./code-common-workflows.md#run-parallel-claude-code-sessions-with-git-worktrees) at `<repo>/.claude/worktrees/<name>`. If no name is given, one is auto-generated    | `claude -w feature-auth`                                                                           |
...
| `tools`           | No       | Array of specific tools the subagent can use, for example `["Read", "Edit", "Bash"]`. If omitted, inherits all tools. Supports [`Task(agent_type)`](./code-sub-agents.md#restrict-which-subagents-can-be-spawned) syntax |
...
| `skills`          | No       | Array of [skill](./code-skills.md) names to preload into the subagent's context                                                                                                                                          |
| `mcpServers`      | No       | Array of [MCP servers](./code-mcp.md) for this subagent. Each entry is a server name string or a `{name: config}` object                                                                                                 |
...
For more details on creating and using subagents, see the [subagents documentation](./code-sub-agents.md).
...
* [Chrome extension](./code-chrome.md) - Browser automation and web testing
* [Interactive mode](./code-interactive-mode.md) - Shortcuts, input modes, and interactive features
* [Quickstart guide](./code-quickstart.md) - Getting started with Claude Code
* [Common workflows](./code-common-workflows.md) - Advanced workflows and patterns
* [Settings](./code-settings.md) - Configuration options

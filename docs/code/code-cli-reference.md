...
| `--init`                               | Run [Setup hooks](./code-hooks.md#setup) and start interactive mode                                                                                                                                             | `claude --init`                                                                                    |
| `--init-only`                          | Run [Setup hooks](./code-hooks.md#setup) and exit (no interactive session)                                                                                                                                      | `claude --init-only`                                                                               |
...
| `--maintenance`                        | Run [Setup hooks](./code-hooks.md#setup) with maintenance trigger and exit                                                                                                                                      | `claude --maintenance`                                                                             |
...
| `--permission-mode`                    | Begin in a specified [permission mode](./code-iam.md#permission-modes)                                                                                                                                          | `claude --permission-mode plan`                                                                    |

...
If you encounter any issues during installation, consult the [troubleshooting guide](./troubleshooting.md#linux-permission-issues).
...
<Warning>
  ...
  If you encounter permission errors, see [configure Claude Code](./troubleshooting.md#linux-permission-issues) for recommended solutions.
</Warning>
...
For details on running Claude Code on AWS or GCP, see [third-party integrations](./third-party-integrations.md).

...
For complete details on plugin command structure, invocation patterns, and features, see [Plugin commands](./code-slash-commands.md#plugin-commands).
...
* [Use Skills in Claude Code](./code-skills.md)

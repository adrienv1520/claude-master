...
<Tip>
  Looking to install plugins? See [Discover and install plugins](./code-discover-plugins.md). For creating plugins, see [Plugins](./code-plugins.md). For distributing plugins, see [Plugin marketplaces](./code-plugin-marketplaces.md).
</Tip>
...
For complete details, see [Skills](./code-skills.md).
...
For complete details, see [Subagents](./code-sub-agents.md).
...
Plugin hooks respond to the same lifecycle events as [user-defined hooks](./code-hooks.md):
...
| `managed` | [Managed settings](./code-settings.md#settings-files) | Managed plugins (read-only, update only)                 |

Plugins use the same scope system as other Claude Code configurations. For installation instructions and scope flags, see [Install plugins](./code-discover-plugins.md#install-plugins). For a complete explanation of scopes, see [Configuration scopes](./code-settings.md#configuration-scopes).
...
| **Settings**      | `settings.json`              | Default configuration applied when the plugin is enabled. Only [`agent`](./code-sub-agents.md) settings are currently supported |
...
<Warning>
  ...
  If your plugin is within a [marketplace](./code-plugin-marketplaces.md) directory, you can manage the version through `marketplace.json` instead and omit the `version` field from `plugin.json`.
</Warning>
...
* [Plugins](./code-plugins.md) - Tutorials and practical usage
* [Plugin marketplaces](./code-plugin-marketplaces.md) - Creating and managing marketplaces
...
* [Settings](./code-settings.md) - Configuration options for plugins

...
* Basic familiarity with [Claude Code](./quickstart.md)
...
Skills can also come from [Claude Code plugins](./plugins.md). Plugins may bundle Skills that are automatically available when the plugin is installed. These Skills work the same way as personal and project Skills.
...
**Recommended approach**: Distribute Skills through [plugins](./plugins.md).
...
For complete instructions, see [Add Skills to your plugin](./plugins.md#add-skills-to-your-plugin).

...
You may also see plugins with **managed** scope—these are installed by enterprise administrators via [managed settings](./code-settings.md#enterprise-managed-policy-settings) and cannot be modified.

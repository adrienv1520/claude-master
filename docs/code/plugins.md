...
<Tip>
  For complete technical specifications and schemas, see [Plugins reference](./plugins-reference.md). For marketplace management, see [Plugin marketplaces](./plugin-marketplaces.md).
</Tip>

Plugins let you extend Claude Code with custom functionality that can be shared across projects and teams. Install plugins from [marketplaces](./plugin-marketplaces.md) to add pre-built commands, agents, hooks, Skills, and MCP servers, or create your own to automate your workflows.
...
<Note>
  **Next steps**: Ready to add more features? Jump to [Develop more complex plugins](#develop-more-complex-plugins) to add agents, hooks, and MCP servers. For complete technical specifications of all plugin components, see [Plugins reference](./plugins-reference.md).
</Note>
...
For detailed marketplace management including Git repositories, local development, and team distribution, see [Plugin marketplaces](./plugin-marketplaces.md).
...
For complete instructions including configuration examples, marketplace setup, and rollout best practices, see [Configure team marketplaces](./plugin-marketplaces.md#how-to-configure-team-marketplaces).
...
<Note>
  **For multiple plugins**: Organize plugins in subdirectories like `./plugins/plugin-name` and update your marketplace.json accordingly. See [Plugin sources](./plugin-marketplaces.md#plugin-sources) for organization patterns.
</Note>
...
* **Create your first marketplace**: [Plugin marketplaces guide](./plugin-marketplaces.md)
...
* [Plugin marketplaces](./plugin-marketplaces.md) - Creating and managing plugin catalogs
* [Slash commands](./slash-commands.md) - Understanding custom commands
* [Subagents](./sub-agents.md) - Creating and using specialized agents
* [Agent Skills](./skills.md) - Extend Claude's capabilities
* [Hooks](./hooks.md) - Automating workflows with event handlers

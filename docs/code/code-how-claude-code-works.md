...
These are the primary capabilities. Claude also has tools for spawning subagents, asking you questions, and other orchestration tasks. See [Tools available to Claude](./code-tools-reference.md) for the complete list.
...
This guide focuses on the terminal. Claude Code also runs in [VS Code](./code-vs-code.md), [JetBrains IDEs](./code-jetbrains.md), and other environments.

...
* A [Claude subscription](https://claude.com/pricing) (Pro, Max, Teams, or Enterprise), [Claude Console](https://console.anthropic.com/) account, or access through a [supported cloud provider](./code-third-party-integrations.md)
...
<Tabs>
  ...
  <Tab title="Homebrew">
    ```sh theme={null} theme={null} theme={null} theme={null} theme={null} theme={null} theme={null} theme={null} theme={null}
...
<Tip>
  After logging in (Step 2), your credentials are stored on your system. Learn more in [Credential Management](./code-iam.md#credential-management).
</Tip>

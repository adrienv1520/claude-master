...
<Tip>
  Claude Code automatically keeps itself up to date. See [advanced setup](./code-setup.md) for installation options, manual updates, or uninstallation instructions. Visit [troubleshooting](./code-troubleshooting.md) if you hit issues.
</Tip>

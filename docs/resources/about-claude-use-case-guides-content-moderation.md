...
<Tip>This guide is focused on moderating user-generated content within your application. If you're looking for guidance on moderating interactions with Claude, please refer to our [guardrails guide](../developer/test-and-evaluate-strengthen-guardrails-reduce-hallucinations.md).</Tip>
...
<CardGroup cols={2}> 
  ...
  <Card title="Guardrails guide" icon="link" href="../developer/test-and-evaluate-strengthen-guardrails-reduce-hallucinations.md">

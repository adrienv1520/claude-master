...
Work with your support team to [define clear success criteria](../developer/developer-test-and-evaluate-define-success.md) with measurable benchmarks, thresholds, and goals.
...
<Tip>
Try the [prompt generator](https://platform.claude.com/docs/en/prompt-generator.md) on the [Claude Console](/login) to have Claude write a first draft for you.
</Tip>
...
It’s hard to know how well your prompt works without deploying it in a test production setting and [running evaluations](../developer/developer-test-and-evaluate-develop-tests.md).
...
To run your evaluation, you will need test cases to run it on. The rest of this guide assumes you have already [developed your test cases](../developer/developer-test-and-evaluate-develop-tests.md).

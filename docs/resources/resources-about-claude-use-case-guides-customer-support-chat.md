...
Work with your support team to [define success criteria and write detailed evaluations](../developer/developer-test-and-evaluate-develop-tests.md) with measurable benchmarks and goals.
...
It's hard to know how well your prompt works without deploying it in a test production setting and [running evaluations](../developer/developer-test-and-evaluate-develop-tests.md) so let's build a small application using the prompt, the Anthropic SDK, and streamlit for a user interface.
...
Prompting often requires testing and optimization for it to be production ready. To determine the readiness of your solution, evaluate the chatbot performance using a systematic process combining quantitative and qualitative methods. Creating a [strong empirical evaluation](../developer/developer-test-and-evaluate-develop-tests.md#building-evals-and-test-cases) based on your defined success criteria will allow you to optimize your prompts.
...
- [Reduce hallucination](../developer/developer-test-and-evaluate-strengthen-guardrails-reduce-hallucinations.md): Implement fact-checking mechanisms and [citations](https://platform.claude.com/cookbook/misc-using-citations) to ground responses in provided information.
...
- [Mitigate jailbreaks](../developer/developer-test-and-evaluate-strengthen-guardrails-mitigate-jailbreaks.md): Use methods like harmlessness screens and input validation to prevent users from exploiting model vulnerabilities, aiming to generate inappropriate content.
...
- [Increase output consistency](../developer/developer-test-and-evaluate-strengthen-guardrails-increase-consistency.md): Prevent Claude from changing style or going out of character, even during long, complex interactions.
...
1. Use the [Anthropic Streaming API](../developer/developer-build-with-claude-streaming.md) to support streaming responses.
...
- Ensure that you are making the most out of your prompts and optimizing through prompt engineering. Use the [prompt engineering guides](../developer/developer-build-with-claude-prompt-engineering-overview.md) to write the most effective prompts.
- Add additional [tools](https://platform.claude.com/docs/en/build-with-claude/tool-use.md) to the prompt (which can include [prompt chains](../developer/developer-build-with-claude-prompt-engineering-claude-prompting-best-practices.md#chain-complex-prompts)) and see if you can achieve the functionality required.

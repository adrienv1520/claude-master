...
This SDK provides support for tool use, also known as function calling. More details can be found in the [tool use overview](../developer/developer-agents-and-tools-tool-use-overview.md).
...
This SDK provides support for the [Message Batches API](../developer/developer-build-with-claude-batch-processing.md) under `client.messages.batches`.
...
> For more information on debugging requests, see the [errors documentation](./api-errors.md#request-id).
...
We introduce beta features before they are generally available to get early feedback and test new functionality. You can check the availability of all of Claude's capabilities and tools in the [build with Claude overview](../developer/developer-build-with-claude-overview.md).
...
For a full list of available Bedrock models, see the [Amazon Bedrock documentation](../developer/developer-build-with-claude-claude-on-amazon-bedrock.md).
...
For a full list of available Vertex models, see the [Google Vertex AI documentation](../developer/developer-build-with-claude-claude-on-vertex-ai.md).

...
<Note>
**New to Claude?** Start with [Get started](./api-get-started.md) for prerequisites and your first API call, or see [Working with Messages](../developer/developer-build-with-claude-working-with-messages.md) for request/response patterns and examples.
</Note>
...
For step-by-step setup instructions, see [Get started](./api-get-started.md).
...
The Messages API supports an optional `inference_geo` parameter for [data residency controls](../developer/developer-build-with-claude-data-residency.md), allowing you to specify where model inference runs.
...
|----------|----------|---------------|
| Amazon Bedrock | AWS | [Claude on Amazon Bedrock](../developer/developer-build-with-claude-claude-on-amazon-bedrock.md) |
| Vertex AI | Google Cloud | [Claude on Vertex AI](../developer/developer-build-with-claude-claude-on-vertex-ai.md) |
| Azure AI | Microsoft Azure | [Claude on Azure AI](../developer/developer-build-with-claude-claude-in-microsoft-foundry.md) |

<Note>
For feature availability across platforms, see the [Features overview](../developer/developer-build-with-claude-overview.md).
</Note>
...
| [Batch API](../developer/developer-build-with-claude-batch-processing.md) | 256 MB |
| [Files API](../developer/developer-build-with-claude-files.md) | 500 MB |
...
For complete examples and tutorials, see [Get started](./api-get-started.md) and [Working with Messages](../developer/developer-build-with-claude-working-with-messages.md).

## Next Steps

<CardGroup cols={3}>
  <Card title="Get started" icon="rocket" href="./api-get-started.md">
    Prerequisites, step-by-step tutorial, and examples in multiple languages
  </Card>
  <Card title="Working with Messages" icon="message" href="../developer/developer-build-with-claude-working-with-messages.md">
    Request/response patterns, multi-turn conversations, and best practices
  </Card>
  <Card title="Messages API Reference" icon="book" href="./api-messages.md">
    Complete API specification: parameters, responses, and error codes
  </Card>
  <Card title="Client SDKs" icon="code" href="./api-client-sdks.md">
    Installation guides for Python, TypeScript, Java, Go, C#, Ruby, and PHP
  </Card>
  <Card title="Features overview" icon="grid" href="../developer/developer-build-with-claude-overview.md">
    Explore capabilities: caching, vision, tool use, streaming, and more
  </Card>
  <Card title="Rate limits" icon="gauge" href="./api-rate-limits.md">

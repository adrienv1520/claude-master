...
<Note>
**New to Claude?** Start with [Get started](./get-started.md) for prerequisites and your first API call, or see [Working with Messages](../developer/build-with-claude-working-with-messages.md) for request/response patterns and examples.
</Note>
...
- **[Messages API](./messages.md)**: Send messages to Claude for conversational interactions (`POST /v1/messages`)
...
|----------|----------|---------------|
| Amazon Bedrock | AWS | [Claude on Amazon Bedrock](../developer/build-with-claude-claude-on-amazon-bedrock.md) |
| Vertex AI | Google Cloud | [Claude on Vertex AI](../developer/build-with-claude-claude-on-vertex-ai.md) |
| Azure AI | Microsoft Azure | [Claude on Azure AI](../developer/build-with-claude-claude-in-microsoft-foundry.md) |

<Note>
For feature availability across platforms, see the [Features overview](../developer/build-with-claude-overview.md).
</Note>
...
| [Batch API](../developer/build-with-claude-batch-processing.md) | 256 MB |
| [Files API](../developer/build-with-claude-files.md) | 500 MB |
...
For complete examples and tutorials, see [Get started](./get-started.md) and [Working with Messages](../developer/build-with-claude-working-with-messages.md).

## Next Steps

<CardGroup cols={3}>
  <Card title="Get started" icon="rocket" href="./get-started.md">
    Prerequisites, step-by-step tutorial, and examples in multiple languages
  </Card>
  <Card title="Working with Messages" icon="message" href="../developer/build-with-claude-working-with-messages.md">
    Request/response patterns, multi-turn conversations, and best practices
  </Card>
  <Card title="Messages API Reference" icon="book" href="./messages.md">
    Complete API specification: parameters, responses, and error codes
  </Card>
  <Card title="Client SDKs" icon="code" href="./client-sdks.md">
    Installation guides for Python, TypeScript, Java, Go, C#, Ruby, and PHP
  </Card>
  <Card title="Features overview" icon="grid" href="../developer/build-with-claude-overview.md">
    Explore capabilities: caching, vision, tool use, streaming, and more
  </Card>
  <Card title="Rate limits" icon="gauge" href="./rate-limits.md">

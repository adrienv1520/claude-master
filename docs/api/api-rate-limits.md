...
For rate limit purposes on most models, only `input_tokens` + `cache_creation_input_tokens` count toward your ITPM limit, making [prompt caching](../developer/developer-build-with-claude-prompt-caching.md) an effective way to increase your effective throughput.
</Note>
...
For all models without the † marker, cached input tokens do not count towards rate limits and are billed at a reduced rate (10% of base input token price). This means you can achieve significantly higher effective throughput by using [prompt caching](../developer/developer-build-with-claude-prompt-caching.md).
</Note>

<Tip>
**Maximize your rate limits with prompt caching**

To get the most out of your rate limits, use [prompt caching](../developer/developer-build-with-claude-prompt-caching.md) for repeated content like:
...
| Claude Sonnet 3.7 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                   | 50                                | 20,000                                 | 8,000                                   |
| Claude Haiku 4.5                                                                             | 50                                | 50,000                                 | 10,000                                  |
| Claude Haiku 3.5 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                    | 50                                | 50,000<sup>†</sup>                     | 10,000                                  |
...
| Claude Sonnet 3.7 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                   | 1,000                             | 40,000                                 | 16,000                                  |
| Claude Haiku 4.5                                                                             | 1,000                             | 450,000                                | 90,000                                  |
| Claude Haiku 3.5 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                    | 1,000                             | 100,000<sup>†</sup>                    | 20,000                                  |
...
| Claude Sonnet 3.7 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                   | 2,000                             | 80,000                                 | 32,000                                  |
| Claude Haiku 4.5                                                                             | 2,000                             | 1,000,000                              | 200,000                                 |
| Claude Haiku 3.5 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                    | 2,000                             | 200,000<sup>†</sup>                    | 40,000                                  |
...
| Claude Sonnet 3.7 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                   | 4,000                             | 200,000                                | 80,000                                  |
| Claude Haiku 4.5                                                                             | 4,000                             | 4,000,000                              | 800,000                                 |
| Claude Haiku 3.5 ([deprecated](../developer/developer-about-claude-model-deprecations.md))                    | 4,000                             | 400,000<sup>†</sup>                    | 80,000                                  |
...
_<sup>** - Sonnet 4.x rate limit is a total limit that applies to combined traffic across Sonnet 4.5 and Sonnet 4.</sup>_
...
When using [fast mode](../developer/developer-build-with-claude-fast-mode.md) (`speed: "fast"`) on Opus 4.6 (research preview), dedicated rate limits apply that are separate from standard Opus rate limits. When fast mode rate limits are exceeded, the API returns a `429` error with a `retry-after` header.

The response includes `anthropic-fast-*` headers that indicate your fast mode rate limit status. See the [fast mode documentation](../developer/developer-build-with-claude-fast-mode.md#rate-limits) for details on these headers.

### Long context rate limits

When using Claude Opus 4.6, Sonnet 4.5, or Sonnet 4 with the [1M token context window enabled](../developer/developer-build-with-claude-context-windows.md#1m-token-context-window), the following dedicated rate limits apply to requests exceeding 200K tokens.
...
<Tip>
To get the most out of the 1M token context window with rate limits, use [prompt caching](../developer/developer-build-with-claude-prompt-caching.md).
</Tip>
...
For more about workspaces, see [Workspaces](../developer/developer-build-with-claude-workspaces.md).

...
When using Claude Opus 4.6, Sonnet 4.6, Sonnet 4.5, or Sonnet 4 with the [1M token context window enabled](../developer/developer-build-with-claude-context-windows.md#1m-token-context-window), the following dedicated rate limits apply to requests exceeding 200K tokens.

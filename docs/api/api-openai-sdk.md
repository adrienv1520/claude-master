...
<Tip>
For the best experience and access to Claude API full feature set ([PDF processing](../developer/developer-build-with-claude-pdf-support.md), [citations](../developer/developer-build-with-claude-citations.md), [extended thinking](../developer/developer-build-with-claude-extended-thinking.md), and [prompt caching](../developer/developer-build-with-claude-prompt-caching.md)), we recommend using the native [Claude API](./api-overview.md).
</Tip>
...
* The `strict` parameter for function calling is ignored, which means the tool use JSON is not guaranteed to follow the supplied schema. For guaranteed schema conformance, use the native [Claude API with Structured Outputs](../developer/developer-build-with-claude-structured-outputs.md).
...
| `logprobs` | Ignored |
| `metadata` | Ignored |
| `response_format` | Ignored. For JSON output, use [Structured Outputs](../developer/developer-build-with-claude-structured-outputs.md) with the native Claude API |
| `prediction` | Ignored |
...
| `strict`     | Ignored. Use [Structured Outputs](../developer/developer-build-with-claude-structured-outputs.md) with native Claude API for strict schema validation |
</Tab>
<Tab title="Functions">

...
Requests in this tier are prioritized over all other requests to Anthropic. This prioritization helps minimize ["server overloaded" errors](./api-errors.md#http-errors), even during peak times.
...
- For [long-context](../developer/developer-build-with-claude-context-windows.md) (>200k input tokens) requests, input tokens are 2 tokens per token
- For [US-only inference](../developer/developer-build-with-claude-data-residency.md) (`inference_geo: "us"`) requests, input tokens are 1.1 tokens per token
- All other input tokens are 1 token per token

**Output Tokens**
- For [long-context](../developer/developer-build-with-claude-context-windows.md) (>200k input tokens) requests, output tokens are 1.5 tokens per token
- For [US-only inference](../developer/developer-build-with-claude-data-residency.md) (`inference_geo: "us"`) requests, output tokens are 1.1 tokens per token
...
- Claude Sonnet 4.5
- Claude Sonnet 4
- Claude Sonnet 3.7 ([deprecated](../developer/developer-about-claude-model-deprecations.md))
- Claude Haiku 4.5
- Claude Haiku 3.5 ([deprecated](../developer/developer-about-claude-model-deprecations.md))

Check the [model overview page](../developer/developer-about-claude-models-overview.md) for more details on our models.

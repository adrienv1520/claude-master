...
<Warning>
 Consider using the [streaming Messages API](../developer/developer-build-with-claude-streaming.md) or [Message Batches API](https://platform.claude.com/docs/en/api/creating-message-batches.md) for long running requests, especially those over 10 minutes.
</Warning>

Avoid setting a large `max_tokens` value without using the [streaming Messages API](../developer/developer-build-with-claude-streaming.md)
...
- Networks differ in reliability; the [Message Batches API](https://platform.claude.com/docs/en/api/creating-message-batches.md) can help you

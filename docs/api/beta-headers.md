...
<Info>
Beta headers are often used in conjunction with the [beta namespace in the client SDKs](./client-sdks.md#beta-namespace-in-client-sdks)
</Info>
...
2. Review the [API changelog](./versioning.md) for updates

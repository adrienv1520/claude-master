...
For rate limit purposes on most models, only `input_tokens` + `cache_creation_input_tokens` count toward your ITPM limit, making [prompt caching](../developer/build-with-claude-prompt-caching.md) an effective way to increase your effective throughput.
</Note>
...
For all models without the † marker, cached input tokens do not count towards rate limits and are billed at a reduced rate (10% of base input token price). This means you can achieve significantly higher effective throughput by using [prompt caching](../developer/build-with-claude-prompt-caching.md).
</Note>

<Tip>
**Maximize your rate limits with prompt caching**

To get the most out of your rate limits, use [prompt caching](../developer/build-with-claude-prompt-caching.md) for repeated content like:
...
| Claude Sonnet 3.7 ([deprecated](../developer/about-claude-model-deprecations.md))                   | 50                                | 20,000                                 | 8,000                                   |
...
| Claude Opus 3 ([deprecated](../developer/about-claude-model-deprecations.md))                      | 50                                | 20,000<sup>†</sup>                     | 4,000                                   |
...
| Claude Sonnet 3.7 ([deprecated](../developer/about-claude-model-deprecations.md))                   | 1,000                             | 40,000                                 | 16,000                                  |
...
| Claude Opus 3 ([deprecated](../developer/about-claude-model-deprecations.md))                      | 1,000                             | 40,000<sup>†</sup>                     | 8,000                                   |
...
| Claude Sonnet 3.7 ([deprecated](../developer/about-claude-model-deprecations.md))                   | 2,000                             | 80,000                                 | 32,000                                  |
...
| Claude Opus 3 ([deprecated](../developer/about-claude-model-deprecations.md))                      | 2,000                             | 80,000<sup>†</sup>                     | 16,000                                  |
...
| Claude Sonnet 3.7 ([deprecated](../developer/about-claude-model-deprecations.md))                   | 4,000                             | 200,000                                | 80,000                                  |
...
| Claude Opus 3 ([deprecated](../developer/about-claude-model-deprecations.md))                      | 4,000                             | 400,000<sup>†</sup>                    | 80,000                                  |
...
When using Claude Sonnet 4 and Sonnet 4.5 with the [1M token context window enabled](../developer/build-with-claude-context-windows.md#1m-token-context-window), the following dedicated rate limits apply to requests exceeding 200K tokens.
...
<Tip>
To get the most out of the 1M token context window with rate limits, use [prompt caching](../developer/build-with-claude-prompt-caching.md).
</Tip>

...
- [Microsoft Azure / Foundry](../developer/developer-build-with-claude-claude-in-microsoft-foundry.md)
</Note>
...
For information on using Claude through Microsoft Azure and Azure AI Foundry, see [Claude in Microsoft Foundry](../developer/developer-build-with-claude-claude-in-microsoft-foundry.md).

...
<Tip>
For the best experience and access to Claude API full feature set ([PDF processing](../developer/build-with-claude-pdf-support.md), [citations](../developer/build-with-claude-citations.md), [extended thinking](../developer/build-with-claude-extended-thinking.md), and [prompt caching](../developer/build-with-claude-prompt-caching.md)), we recommend using the native [Claude API](./overview.md).
</Tip>
...
2. Change the following  
   ...
   * Update your model name to use a [Claude model](../developer/about-claude-models-overview.md)  

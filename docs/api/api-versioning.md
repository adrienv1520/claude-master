...
When making API requests, you must send an `anthropic-version` request header. For example, `anthropic-version: 2023-06-01`. If you are using our [client SDKs](./api-client-sdks.md), this is handled for you automatically.
...
* `2023-06-01`
   * New format for [streaming](../developer/developer-build-with-claude-streaming.md) server-sent events (SSE):

...
For complete structured outputs documentation including Ruby examples, see [Structured Outputs](../developer/developer-build-with-claude-structured-outputs.md).

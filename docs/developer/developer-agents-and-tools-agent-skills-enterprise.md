...
This guide is for enterprise admins and architects who need to govern Agent Skills across an organization. It covers how to vet, evaluate, deploy, and manage Skills at scale. For authoring guidance, see [best practices](./developer-agents-and-tools-agent-skills-best-practices.md). For architecture details, see the [Skills overview](./developer-agents-and-tools-agent-skills-overview.md).

## Security review and vetting

Deploying Skills in an enterprise requires answering two distinct questions:

1. **Are Skills safe in general?** See the [security considerations](./developer-agents-and-tools-agent-skills-overview.md#security-considerations) section in the overview for platform-level security details.
...
For detailed guidance on building evaluations, see [evaluation and iteration](./developer-agents-and-tools-agent-skills-best-practices.md#evaluation-and-iteration) in best practices. For general evaluation methodology, see [develop test cases](./developer-test-and-evaluate-develop-tests.md).
...
<Steps>
  ...
  <Step title="Create and review">
    Ensure the Skill author follows [best practices](./developer-agents-and-tools-agent-skills-best-practices.md). Require a security review using the [review checklist](#review-checklist) above. Require an evaluation suite before approval. Establish separation of duties: Skill authors should not be their own reviewers.
  </Step>
  <Step title="Test">
  ...
  <Step title="Deploy">
    Upload via the Skills API for workspace-wide access. See [Using Skills with the API](./developer-build-with-claude-skills-guide.md) for upload and version management. Document the Skill in your internal registry with purpose, owner, and version.
  </Step>
  <Step title="Monitor">
...
Use consistent naming conventions across your organization. The [naming conventions](./developer-agents-and-tools-agent-skills-best-practices.md#naming-conventions) section in best practices provides formatting guidance.
...
The Skills API provides workspace-scoped distribution. Skills uploaded via the API are available to all workspace members. See [Using Skills with the API](./developer-build-with-claude-skills-guide.md) for upload, versioning, and management endpoints.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="book-open"
    href="./developer-agents-and-tools-agent-skills-overview.md"
  >
  ...
  <Card
    ...
    icon="lightbulb"
    href="./developer-agents-and-tools-agent-skills-best-practices.md"
  >
  ...
  <Card
    ...
    icon="shield"
    href="./developer-agent-sdk-secure-deployment.md"
  >

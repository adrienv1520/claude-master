...
<Note>Prefilling is deprecated and not supported on Claude Opus 4.6 and Claude Sonnet 4.5. Use [structured outputs](./developer-build-with-claude-structured-outputs.md) or system prompt instructions instead.</Note>

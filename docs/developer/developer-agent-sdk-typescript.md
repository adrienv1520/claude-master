...
| `plugins` | [`SdkPluginConfig`](#sdkpluginconfig)`[]` | `[]` | Load custom plugins from local paths. See [Plugins](./developer-agent-sdk-plugins.md) for details |
...
| `rewindFiles(userMessageUuid)` | Restores files to their state at the specified user message. Requires `enableFileCheckpointing: true`. See [File checkpointing](./developer-agent-sdk-file-checkpointing.md) |
...
|:------|:------------|:------------------|
| `'context-1m-2025-08-07'` | Enables 1 million token [context window](./developer-build-with-claude-context-windows.md) | Claude Opus 4.6, Claude Sonnet 4.5, Claude Sonnet 4 |

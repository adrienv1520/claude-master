...
- Claude Sonnet 3.7: May need stronger prompting or the `token-efficient-tools-2025-02-19` [beta header](../api/api-beta-headers.md). Consider [upgrading to Claude 4](./developer-about-claude-models-migrating-to-claude-4.md).

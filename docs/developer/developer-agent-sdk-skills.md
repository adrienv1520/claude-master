...
For comprehensive information about Skills, including benefits, architecture, and authoring guidelines, see the [Agent Skills overview](./developer-agents-and-tools-agent-skills-overview.md).
...
- [Agent Skills Best Practices](./developer-agents-and-tools-agent-skills-best-practices.md): Authoring guidelines and naming conventions
...
For more details on `settingSources`/`setting_sources`, see the [TypeScript SDK reference](./developer-agent-sdk-typescript.md#setting-source) or [Python SDK reference](./developer-agent-sdk-python.md#setting-source).
...
**Check the description**: Ensure it's specific and includes relevant keywords. See [Agent Skills Best Practices](./developer-agents-and-tools-agent-skills-best-practices.md#writing-effective-descriptions) for guidance on writing effective descriptions.
...
- [Agent Skills Overview](./developer-agents-and-tools-agent-skills-overview.md): Conceptual overview, benefits, and architecture
- [Agent Skills Best Practices](./developer-agents-and-tools-agent-skills-best-practices.md): Authoring guidelines for effective Skills
...
### SDK Resources
- [Subagents in the SDK](./developer-agent-sdk-subagents.md): Similar filesystem-based agents with programmatic options
- [Slash Commands in the SDK](./developer-agent-sdk-slash-commands.md): User-invoked commands
...
- [Python SDK Reference](./developer-agent-sdk-python.md): Complete API documentation
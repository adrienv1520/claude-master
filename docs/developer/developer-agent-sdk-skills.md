...
For more details on `settingSources`/`setting_sources`, see the [TypeScript SDK reference](./developer-agent-sdk-typescript.md#settingsource) or [Python SDK reference](./developer-agent-sdk-python.md#settingsource).

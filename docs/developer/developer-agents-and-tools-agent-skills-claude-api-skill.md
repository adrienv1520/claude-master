...
The `claude-api` skill is an open-source [Agent Skill](./developer-agents-and-tools-agent-skills-overview.md) that provides Claude with detailed, up-to-date reference material for building applications with the Claude API and [Agent SDK](./developer-agent-sdk-overview.md). It covers 8 programming languages: Python, TypeScript, Java, Go, Ruby, C#, PHP, and cURL.
...
- **Tool use guidance:** Language-specific examples and [conceptual foundations](./developer-agents-and-tools-tool-use-overview.md) for function calling
...
<CardGroup cols={2}>
  ...
  <Card
    title="Agent SDK"
    icon="cube"
    href="./developer-agent-sdk-overview.md"
  >

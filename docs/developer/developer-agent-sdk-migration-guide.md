...
<Note>
**Documentation Changes:** The Agent SDK documentation has moved from the Claude Code docs to the API Guide under a dedicated [Agent SDK](./developer-agent-sdk-overview.md) section. The Claude Code docs now focus on the CLI tool and automation features.
</Note>
...
- Explore the [Agent SDK Overview](./developer-agent-sdk-overview.md) to learn about available features
- Check out the [TypeScript SDK Reference](./developer-agent-sdk-typescript.md) for detailed API documentation
- Review the [Python SDK Reference](./developer-agent-sdk-python.md) for Python-specific documentation
- Learn about [Custom Tools](./developer-agent-sdk-custom-tools.md) and [MCP Integration](./developer-agent-sdk-mcp.md)
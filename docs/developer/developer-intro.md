...
<Steps>
  ...
  <Step title="Understand the Messages API">
    ...
    [Read the Messages API guide](./developer-build-with-claude-working-with-messages.md)
  </Step>
  <Step title="Choose the right model">
    Compare Claude models by capability and cost to pick the best fit for your use case.

    [See the models overview](./developer-about-claude-models-overview.md)
  </Step>
  <Step title="Explore features and tools">
    ...
    [Browse the features overview](./developer-build-with-claude-overview.md)
  </Step>
</Steps>

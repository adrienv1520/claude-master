...
<CardGroup cols={3}>
  <Card title="Get started" icon="check" href="../api/api-get-started.md">
    Set up your development environment for building with Claude.
  </Card>
  <Card title="Learn about Claude" icon="settings" href="./developer-about-claude-models-overview.md">
    Learn about the family of Claude models.
  </Card>
  <Card title="Prompt Library" icon="books" href="../resources/resources-prompt-library-library.md">
...
<CardGroup cols={3}>
  ...
  <Card title="API Reference" icon="code" href="../api/api-overview.md">
...
<CardGroup cols={2}>
  <Card title="Text and code generation" icon="text-aa" href="https://platform.claude.com/docs/en/build-with-claude/text-generation.md">
    Summarize text, answer questions, extract data, translate text, and explain and generate code. 
  </Card>
  <Card title="Vision" icon="image" href="./developer-build-with-claude-vision.md">

...
<Note>
Compaction is currently in beta. Include the [beta header](../api/api-beta-headers.md) `compact-2026-01-12` in your API requests to use this feature.
</Note>
...
Compaction works well with [prompt caching](./developer-build-with-claude-prompt-caching.md). You can add a `cache_control` breakpoint on compaction blocks to cache the summarized content. The original compacted content is ignored.
...
<CardGroup>
  ...
  <Card title="Context windows" icon="arrows-maximize" href="./developer-build-with-claude-context-windows.md">

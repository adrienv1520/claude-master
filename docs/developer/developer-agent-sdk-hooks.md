...
- Hooks may not fire when the agent hits the [`max_turns`](./developer-agent-sdk-python.md#configuration-options) limit because the session ends before hooks can execute

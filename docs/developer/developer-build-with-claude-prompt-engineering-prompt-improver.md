...
<Note>
Our prompt improver is compatible with all Claude models, including those with extended thinking capabilities. For prompting tips specific to extended thinking models, see [here](./developer-build-with-claude-extended-thinking.md).
</Note>
...
Don't have examples yet? Use our [Test Case Generator](./developer-test-and-evaluate-eval-tool.md#creating-test-cases) to:

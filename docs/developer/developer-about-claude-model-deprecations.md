...
For specific instructions on migrating from Claude 3.7 to Claude 4.5 models, see [Migrating to Claude 4.5](./developer-about-claude-models-migrating-to-claude-4.md).

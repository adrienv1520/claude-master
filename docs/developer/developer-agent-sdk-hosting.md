...
<Info>
For security hardening beyond basic sandboxing (including network controls, credential management, and isolation options), see [Secure Deployment](./developer-agent-sdk-secure-deployment.md).
</Info>
...
The SDK also supports [programmatic sandbox configuration](./developer-agent-sdk-typescript.md#sandbox-settings) for command execution.
...
For self-hosted options (Docker, gVisor, Firecracker) and detailed isolation configuration, see [Isolation Technologies](./developer-agent-sdk-secure-deployment.md#isolation-technologies).
...
- [Secure Deployment](./developer-agent-sdk-secure-deployment.md) - Network controls, credential management, and isolation hardening
- [TypeScript SDK - Sandbox Settings](./developer-agent-sdk-typescript.md#sandbox-settings) - Configure sandbox programmatically
- [Sessions Guide](./developer-agent-sdk-sessions.md) - Learn about session management
- [Permissions](./developer-agent-sdk-permissions.md) - Configure tool permissions
- [Cost Tracking](./developer-agent-sdk-cost-tracking.md) - Monitor API usage
- [MCP Integration](./developer-agent-sdk-mcp.md) - Extend with custom tools
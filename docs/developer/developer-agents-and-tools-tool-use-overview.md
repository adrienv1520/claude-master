...
For the full conceptual model including the agentic loop and when to choose each approach, see [How tool use works](./developer-agents-and-tools-tool-use-how-tool-use-works.md).

For connecting to MCP servers, see the [MCP connector](./developer-agents-and-tools-mcp-connector.md). For building your own MCP client, see [modelcontextprotocol.io](https://modelcontextprotocol.io/docs/develop/build-client).

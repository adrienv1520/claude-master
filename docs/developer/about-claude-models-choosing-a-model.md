...
<CardGroup cols={3}>
  <Card title="Model comparison chart" icon="settings" href="./about-claude-models-overview.md">
    See detailed specifications and pricing for the latest Claude models
  </Card>
  <Card title="What's new in Claude 4.5" icon="sparkle" href="./about-claude-models-whats-new-claude-4-5.md">
    Explore the latest improvements in Claude 4.5 models
  </Card>
  <Card title="Start building" icon="code" href="../api/get-started.md">

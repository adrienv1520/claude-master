...
| Claude Sonnet 3.7 ([deprecated](./developer-about-claude-model-deprecations.md)) | $3 / MTok         | $3.75 / MTok    | $6 / MTok       | $0.30 / MTok | $15 / MTok    |
| Claude Haiku 4.5  | $1 / MTok         | $1.25 / MTok    | $2 / MTok       | $0.10 / MTok | $5 / MTok     |
| Claude Haiku 3.5  | $0.80 / MTok      | $1 / MTok       | $1.6 / MTok     | $0.08 / MTok | $4 / MTok     |
| Claude Opus 3 ([deprecated](./developer-about-claude-model-deprecations.md))    | $15 / MTok        | $18.75 / MTok   | $30 / MTok      | $1.50 / MTok | $75 / MTok    |
...
Claude models are available on [AWS Bedrock](./developer-build-with-claude-claude-on-amazon-bedrock.md), [Google Vertex AI](./developer-build-with-claude-claude-on-vertex-ai.md), and [Microsoft Foundry](./developer-build-with-claude-claude-in-microsoft-foundry.md). For official pricing, visit:
...
- [AWS Bedrock global vs regional endpoints](./developer-build-with-claude-claude-on-amazon-bedrock.md#global-vs-regional-endpoints)
- [Google Vertex AI global vs regional endpoints](./developer-build-with-claude-claude-on-vertex-ai.md#global-vs-regional-endpoints)
</Note>
...
[Fast mode](./developer-build-with-claude-fast-mode.md) for Claude Opus 4.6 (resesarch preview) provides significantly faster output at premium pricing (6x standard rates). Currently supported on Opus 4.6:
...
- [Data residency](./developer-build-with-claude-data-residency.md) multipliers apply on top of fast mode pricing

Fast mode is not available with the [Batch API](#batch-processing).

For more information, see the [fast mode documentation](./developer-build-with-claude-fast-mode.md).
...
| Claude Sonnet 3.7 ([deprecated](./developer-about-claude-model-deprecations.md)) | $1.50 / MTok     | $7.50 / MTok    |
| Claude Haiku 4.5  | $0.50 / MTok     | $2.50 / MTok    |
| Claude Haiku 3.5  | $0.40 / MTok     | $2 / MTok       |
| Claude Opus 3 ([deprecated](./developer-about-claude-model-deprecations.md))  | $7.50 / MTok     | $37.50 / MTok   |
| Claude Haiku 3    | $0.125 / MTok    | $0.625 / MTok   |

For more information about batch processing, see the [batch processing documentation](./developer-build-with-claude-batch-processing.md).

### Long context pricing

When using Claude Opus 4.6, Sonnet 4.5, or Sonnet 4 with the [1M token context window enabled](./developer-build-with-claude-context-windows.md#1m-token-context-window), requests that exceed 200K input tokens are automatically charged at premium long context rates:
...
| Claude Sonnet 3.7 ([deprecated](./developer-about-claude-model-deprecations.md))        | `auto`, `none`<hr />`any`, `tool`   | 346 tokens<hr />313 tokens |
...
| Claude Opus 3 ([deprecated](./developer-about-claude-model-deprecations.md))            | `auto`, `none`<hr />`any`, `tool`   | 530 tokens<hr />281 tokens |
...
For more information about tool use implementation and best practices, see the [tool use documentation](./developer-agents-and-tools-tool-use-overview.md).
...
| `text_editor_20250124` (Claude Sonnet 3.7 ([deprecated](./developer-about-claude-model-deprecations.md))) | 700 tokens |
...
Computer use follows the standard [tool use pricing](./developer-agents-and-tools-tool-use-overview.md#pricing). When using the computer use tool:
...
| Claude Sonnet 3.7 ([deprecated](./developer-about-claude-model-deprecations.md)) | 735 tokens |

**Additional token consumption**:
- Screenshot images (see [Vision pricing](./developer-build-with-claude-vision.md))
...
For a detailed walkthrough of this calculation, see the [customer support agent guide](../resources/resources-about-claude-use-case-guides-customer-support-chat.md).
...
For a comprehensive guide on agent pricing patterns, see the [agent use cases guide](https://platform.claude.com/docs/en/about-claude/use-case-guides.md).

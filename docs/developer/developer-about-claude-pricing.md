...
For more information, see our [data residency documentation](./developer-build-with-claude-data-residency.md).
...
For more information about batch processing, see our [batch processing documentation](./developer-build-with-claude-batch-processing.md).
...
For more information about tool use implementation and best practices, see our [tool use documentation](./developer-agents-and-tools-tool-use-overview.md).
...
For a detailed walkthrough of this calculation, see our [customer support agent guide](../resources/resources-about-claude-use-case-guides-customer-support-chat.md).
...
For a comprehensive guide on agent pricing patterns, see our [agent use cases guide](https://platform.claude.com/docs/en/about-claude/use-case-guides.md).
...
For detailed rate limit information, see our [rate limits documentation](../api/api-rate-limits.md).

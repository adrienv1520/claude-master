...
<sup>1</sup> With [extended thinking](./build-with-claude-extended-thinking.md).
...
We also suggest following our general [prompt engineering guidelines](./build-with-claude-prompt-engineering-overview.md) to better improve Claude's performance.

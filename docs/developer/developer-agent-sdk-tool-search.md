...
For details on the underlying API mechanism, see [Tool search in the API](./developer-agents-and-tools-tool-use-tool-search-tool.md).
...
Tool search applies to all registered tools, whether they come from remote MCP servers or [custom SDK MCP servers](./developer-agent-sdk-custom-tools.md). When using `auto`, the threshold is based on the combined size of all tool definitions across all servers.
...
- [Tool search in the API](./developer-agents-and-tools-tool-use-tool-search-tool.md): Full API documentation for tool search, including custom implementations
- [Connect MCP servers](./developer-agent-sdk-mcp.md): Connect to external tools via MCP servers
- [Custom tools](./developer-agent-sdk-custom-tools.md): Build your own tools with SDK MCP servers
- [TypeScript SDK reference](./developer-agent-sdk-typescript.md): Full API reference
- [Python SDK reference](./developer-agent-sdk-python.md): Full API reference
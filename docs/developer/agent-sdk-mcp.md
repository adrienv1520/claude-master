...
In-process servers running within your application. For detailed information on creating custom tools, see the [Custom Tools guide](./agent-sdk-custom-tools.md):
...
- [Custom Tools Guide](./agent-sdk-custom-tools.md) - Detailed guide on creating SDK MCP servers
- [TypeScript SDK Reference](./agent-sdk-typescript.md)
- [Python SDK Reference](./agent-sdk-python.md)
- [SDK Permissions](./agent-sdk-permissions.md)

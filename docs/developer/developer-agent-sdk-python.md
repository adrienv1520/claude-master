...
<Warning>
The `context-1m-2025-08-07` beta is retired as of April 30, 2026. Requests using this header with Claude Sonnet 4.5 or Sonnet 4 will return a 400 error. To use a 1M-token context window, migrate to [Claude Sonnet 4.6 or Claude Opus 4.6](./developer-about-claude-models-overview.md), which include 1M context at standard pricing with no beta header required.
</Warning>

...
- **[Prompt generator](./developer-build-with-claude-prompt-engineering-prompt-generator.md):** Decides what variables your prompt needs and includes them in the template it outputs
- **[Prompt improver](./developer-build-with-claude-prompt-engineering-prompt-improver.md):** Takes your existing template, including all variables, and maintains them in the improved template it outputs
...
<CardGroup cols={2}>
  <Card title="Generate a prompt" icon="link" href="./developer-build-with-claude-prompt-engineering-prompt-generator.md">
    Learn about the prompt generator in the Claude Console and try your hand at getting Claude to generate a prompt for you.
  </Card>
  <Card title="Apply XML tags" icon="link" href="./developer-build-with-claude-prompt-engineering-use-xml-tags.md">

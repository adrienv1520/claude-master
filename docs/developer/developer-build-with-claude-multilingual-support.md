...
<sup>1</sup> With [extended thinking](./developer-build-with-claude-extended-thinking.md).
...
Also follow the general [prompt engineering guidelines](./developer-build-with-claude-prompt-engineering-overview.md) to better improve Claude's performance.

...
<Note>
**Documentation Changes:** The Agent SDK documentation has moved from the Claude Code docs to the API Guide under a dedicated [Agent SDK](./agent-sdk-overview.md) section. The Claude Code docs now focus on the CLI tool and automation features.
</Note>

...
For a comprehensive guide to workspaces, including Console and API examples, see [Workspaces](./developer-build-with-claude-workspaces.md).
...
Track your organization's usage and costs with the [Usage and Cost API](./developer-build-with-claude-usage-cost-api.md).

## Claude Code analytics

Monitor developer productivity and Claude Code adoption with the [Claude Code Analytics API](./developer-build-with-claude-claude-code-analytics-api.md).
...
For workspace-specific questions, see the [Workspaces FAQ](./developer-build-with-claude-workspaces.md#faq).
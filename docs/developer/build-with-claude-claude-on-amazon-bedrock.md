...
PDF support is available on Amazon Bedrock through both the Converse API and InvokeModel API. For detailed information about PDF processing capabilities and limitations, see the [PDF support documentation](./build-with-claude-pdf-support.md#amazon-bedrock-pdf-support).
...
For more details on the two document processing modes and their limitations, refer to the [PDF support guide](./build-with-claude-pdf-support.md#amazon-bedrock-pdf-support).

### 1M token context window

Claude Sonnet 4 and 4.5 support the [1M token context window](./build-with-claude-context-windows.md#1m-token-context-window) on Amazon Bedrock.
...
- **Anthropic pricing details:** [Pricing documentation](./about-claude-pricing.md#third-party-platform-pricing)
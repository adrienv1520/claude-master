...
<CardGroup cols={3}>
  <Card title="Get started" icon="check" href="../api/get-started.md">
    Set up your development environment for building with Claude.
  </Card>
  <Card title="Learn about Claude" icon="settings" href="./about-claude-models-overview.md">
    Learn about the family of Claude models.
  </Card>
  <Card title="Prompt Library" icon="books" href="../resources/prompt-library-library.md">
...
<CardGroup cols={3}>
  ...
  <Card title="API Reference" icon="code" href="../api/overview.md">
...
<CardGroup cols={2}>
  ...
  <Card title="Vision" icon="image" href="./build-with-claude-vision.md">

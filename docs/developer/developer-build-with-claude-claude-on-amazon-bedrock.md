...
Claude Opus 4.6 and Sonnet 4.6 have a [1M-token context window](./developer-build-with-claude-context-windows.md) on Amazon Bedrock. Other Claude models, including Sonnet 4.5 and Sonnet 4, have a 200k-token context window.

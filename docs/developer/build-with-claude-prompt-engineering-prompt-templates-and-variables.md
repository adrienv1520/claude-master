...
- **[Prompt generator](./build-with-claude-prompt-engineering-prompt-generator.md):** Decides what variables your prompt needs and includes them in the template it outputs
- **[Prompt improver](./build-with-claude-prompt-engineering-prompt-improver.md):** Takes your existing template, including all variables, and maintains them in the improved template it outputs
- **[Evaluation tool](./test-and-evaluate-eval-tool.md):** Allows you to easily test, scale, and track versions of your prompts by separating the variable and fixed portions of your prompt template
...
<CardGroup cols={2}>
  <Card title="Generate a prompt" icon="link" href="./build-with-claude-prompt-engineering-prompt-generator.md">
    Learn about the prompt generator in the Claude Console and try your hand at getting Claude to generate a prompt for you.
  </Card>
  <Card title="Apply XML tags" icon="link" href="./build-with-claude-prompt-engineering-use-xml-tags.md">

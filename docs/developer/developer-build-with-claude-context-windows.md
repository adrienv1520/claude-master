...
<Note>
You can read more about the context window and extended thinking in our [extended thinking guide](./developer-build-with-claude-extended-thinking.md).
</Note>
...
For more information about using tools with extended thinking, see our [extended thinking guide](./developer-build-with-claude-extended-thinking.md#extended-thinking-with-tool-use).
</Note>
...
<Note>
The 1M token context window is currently in beta for organizations in [usage tier](../api/api-rate-limits.md) 4 and organizations with custom rate limits. The 1M token context window is only available for Claude Sonnet 4 and Sonnet 4.5.
</Note>
...
For prompting guidance on leveraging context awareness, see our [Claude 4 best practices guide](./developer-build-with-claude-prompt-engineering-claude-4-best-practices.md#context-awareness-and-multi-window-workflows).
...
To plan your token usage and ensure you stay within context window limits, you can use the [token counting API](./developer-build-with-claude-token-counting.md) to estimate how many tokens your messages will use before sending them to Claude.

See our [model comparison](./developer-about-claude-models-overview.md#latest-models-comparison) table for a list of context window sizes by model.

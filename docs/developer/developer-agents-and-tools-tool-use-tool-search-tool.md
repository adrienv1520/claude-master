...
For configuring `mcp_toolset` with `defer_loading`, see [MCP connector](./developer-agents-and-tools-mcp-connector.md).
...
<CardGroup cols={2}>
  <Card title="Tool reference" icon="list" href="./developer-agents-and-tools-tool-use-tool-reference.md">

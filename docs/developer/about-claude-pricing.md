...
| Claude Sonnet 3.7 ([deprecated](./about-claude-model-deprecations.md)) | $3 / MTok         | $3.75 / MTok    | $6 / MTok       | $0.30 / MTok | $15 / MTok    |
| Claude Haiku 4.5  | $1 / MTok         | $1.25 / MTok    | $2 / MTok       | $0.10 / MTok | $5 / MTok     |
| Claude Haiku 3.5  | $0.80 / MTok      | $1 / MTok       | $1.6 / MTok     | $0.08 / MTok | $4 / MTok     |
| Claude Opus 3 ([deprecated](./about-claude-model-deprecations.md))    | $15 / MTok        | $18.75 / MTok   | $30 / MTok      | $1.50 / MTok | $75 / MTok    |
| Claude Haiku 3    | $0.25 / MTok      | $0.30 / MTok    | $0.50 / MTok    | $0.03 / MTok | $1.25 / MTok  |

<Note>
MTok = Million tokens. The "Base Input Tokens" column shows standard input pricing, "Cache Writes" and "Cache Hits" are specific to [prompt caching](./build-with-claude-prompt-caching.md), and "Output Tokens" shows output pricing. Prompt caching offers both 5-minute (default) and 1-hour cache durations to optimize costs for different use cases.
...
| Claude Sonnet 3.7 ([deprecated](./about-claude-model-deprecations.md)) | $1.50 / MTok     | $7.50 / MTok    |
| Claude Haiku 4.5  | $0.50 / MTok     | $2.50 / MTok    |
| Claude Haiku 3.5  | $0.40 / MTok     | $2 / MTok       |
| Claude Opus 3 ([deprecated](./about-claude-model-deprecations.md))  | $7.50 / MTok     | $37.50 / MTok   |
| Claude Haiku 3    | $0.125 / MTok    | $0.625 / MTok   |

For more information about batch processing, see our [batch processing documentation](./build-with-claude-batch-processing.md).

### Long context pricing

When using Claude Sonnet 4 or Sonnet 4.5 with the [1M token context window enabled](./build-with-claude-context-windows.md#1m-token-context-window), requests that exceed 200K input tokens are automatically charged at premium long context rates:

<Note>
The 1M token context window is currently in beta for organizations in [usage tier](../api/rate-limits.md) 4 and organizations with custom rate limits. The 1M token context window is only available for Claude Sonnet 4 and Sonnet 4.5.
</Note>
...
For more information about the `usage` object, see the [API response documentation](../api/messages.md#response-usage).
...
| Claude Sonnet 3.7 ([deprecated](./about-claude-model-deprecations.md))        | `auto`, `none`<hr />`any`, `tool`   | 346 tokens<hr />313 tokens |
...
| Claude Opus 3 ([deprecated](./about-claude-model-deprecations.md))            | `auto`, `none`<hr />`any`, `tool`   | 530 tokens<hr />281 tokens |
...
For more information about tool use implementation and best practices, see our [tool use documentation](./agents-and-tools-tool-use-overview.md).
...
| `text_editor_20250124` (Claude Sonnet 3.7 ([deprecated](./about-claude-model-deprecations.md))) | 700 tokens |
...
| Claude Sonnet 3.7 ([deprecated](./about-claude-model-deprecations.md)) | 735 tokens |
...
For a detailed walkthrough of this calculation, see our [customer support agent guide](../resources/about-claude-use-case-guides-customer-support-chat.md).
...
For detailed rate limit information, see our [rate limits documentation](../api/rate-limits.md).

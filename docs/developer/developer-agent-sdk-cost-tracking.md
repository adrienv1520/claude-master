...
The examples in this section use TypeScript field names. In Python, the equivalent fields are [`AssistantMessage.usage`](./developer-agent-sdk-python.md#assistant-message) and `AssistantMessage.message_id` for per-step usage, and [`ResultMessage.model_usage`](./developer-agent-sdk-python.md#result-message) for per-model breakdowns.

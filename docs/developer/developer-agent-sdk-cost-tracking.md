...
For complete API documentation, see the [TypeScript SDK reference](./developer-agent-sdk-typescript.md).
...
For the complete type definitions, see the [TypeScript SDK reference](./developer-agent-sdk-typescript.md).

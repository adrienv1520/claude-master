...
Programmatic tool calling uses the same pricing as code execution. See the [code execution pricing](./agents-and-tools-tool-use-code-execution-tool.md#usage-and-pricing) for details.
...
<CardGroup cols={2}>
  <Card title="Code Execution Tool" icon="code" href="./agents-and-tools-tool-use-code-execution-tool.md">
    Learn about the underlying code execution capability that powers programmatic tool calling.
  </Card>
  <Card title="Tool Use Overview" icon="wrench" href="./agents-and-tools-tool-use-overview.md">
    Understand the fundamentals of tool use with Claude.
  </Card>
  <Card title="Implement Tool Use" icon="hammer" href="./agents-and-tools-tool-use-implement-tool-use.md">

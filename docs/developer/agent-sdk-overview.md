...
The Claude Agent SDK is available in multiple forms to suit different use cases:
  ...
  - **[TypeScript SDK](./agent-sdk-typescript.md)** - For Node.js and web applications
  - **[Python SDK](./agent-sdk-python.md)** - For Python applications and data science
  - **[Streaming vs Single Mode](./agent-sdk-streaming-vs-single-mode.md)** - Understanding input modes and best practices

...
Define custom tools directly in your application code instead of running a separate server process. See the [custom tools guide](./developer-agent-sdk-custom-tools.md) for implementation details.
...
- **[Custom tools guide](./developer-agent-sdk-custom-tools.md)**: Build your own MCP server that runs in-process with your SDK application
- **[Permissions](./developer-agent-sdk-permissions.md)**: Control which MCP tools your agent can use with `allowedTools` and `disallowedTools`
- **[TypeScript SDK reference](./developer-agent-sdk-typescript.md)**: Full API reference including MCP configuration options
- **[Python SDK reference](./developer-agent-sdk-python.md)**: Full API reference including MCP configuration options

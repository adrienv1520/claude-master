...
<Note>
The prompt generator is compatible with all Claude models, including those with extended thinking capabilities. For prompting tips specific to extended thinking models, see the [extended thinking documentation](./developer-build-with-claude-extended-thinking.md).
</Note>
...
<CardGroup cols={2}>
  <Card title="Start prompt engineering" icon="link" href="./developer-build-with-claude-prompt-engineering-be-clear-and-direct.md">

...
Claude Opus 4.6, Sonnet 4.6, Sonnet 4.5, and Sonnet 4 have a [1M-token context window](./developer-build-with-claude-context-windows.md) on Vertex AI.

<Note>
For Claude Sonnet 4.5 and Sonnet 4, the 1M-token context window is in beta. To use, include the `context-1m-2025-08-07` [beta header](../api/api-beta-headers.md) in your API requests.
</Note>

...
[Web search](./developer-agents-and-tools-tool-use-web-search-tool.md) and [web fetch](./developer-agents-and-tools-tool-use-web-fetch-tool.md) tools now support dynamic filtering in public beta with Opus 4.6 and Sonnet 4.6. Claude can write and execute code to filter results before they reach the context window, keeping only relevant information and improving accuracy while reducing token consumption. To enable dynamic filtering, use the `web_search_20260209` or `web_fetch_20260209` tool versions with the `code-execution-web-tools-2026-02-09` beta header.
...
- [Tool use examples](./developer-agents-and-tools-tool-use-implement-tool-use.md#providing-tool-use-examples)

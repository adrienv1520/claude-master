...
- [Prompt caching multipliers](./developer-about-claude-pricing.md#model-pricing) apply on top of fast mode pricing
- [Data residency](./developer-build-with-claude-data-residency.md) multipliers apply on top of fast mode pricing

For complete pricing details, see the [pricing page](./developer-about-claude-pricing.md#fast-mode-pricing).
...
<Note>
Falling back from fast to standard speed will result in a [prompt cache](./developer-build-with-claude-prompt-caching.md) miss. Requests at different speeds do not share cached prefixes.
</Note>
...
<CardGroup>
  ...
  <Card title="Effort parameter" icon="sliders" href="./developer-build-with-claude-effort.md">

...
Don't have examples yet? Use our [Test Case Generator](./test-and-evaluate-eval-tool.md#creating-test-cases) to:
...
<CardGroup cols={3}>
  ...
  <Card title="Test your prompts" icon="link" href="./test-and-evaluate-eval-tool.md">

...
- [Skill Management API Reference](https://platform.claude.com/docs/en/api/skills/list-skills.md) - CRUD operations for Skills
- [Skill Versions API Reference](https://platform.claude.com/docs/en/api/skills/list-skill-versions.md) - Version management
</Note>
...
| **Management** | Pre-built and maintained by Anthropic | Upload and manage via [Skills API](https://platform.claude.com/docs/en/api/skills/create-skill.md) |
| **Availability** | Available to all users | Private to your workspace |

Both skill sources are returned by the [List Skills endpoint](https://platform.claude.com/docs/en/api/skills/list-skills.md) (use the `source` parameter to filter). The integration shape and execution environment are identical. The only difference is where the Skills come from and how they're managed.
...
For complete request/response schemas, see the [Create Skill API reference](https://platform.claude.com/docs/en/api/skills/create-skill.md).
...
See the [List Skills API reference](https://platform.claude.com/docs/en/api/skills/list-skills.md) for pagination and filtering options.
...
See the [Create Skill Version API reference](https://platform.claude.com/docs/en/api/skills/create-skill-version.md) for complete details.
...
See the [code execution tool documentation](./developer-agents-and-tools-tool-use-code-execution-tool.md) for available packages.
...
<CardGroup cols={2}>
  <Card
    title="API Reference"
    icon="book"
    href="https://platform.claude.com/docs/en/api/skills/create-skill.md"
  >
  ...
  <Card
    ...
    icon="terminal"
    href="./developer-agents-and-tools-tool-use-code-execution-tool.md"
  >

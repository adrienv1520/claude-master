...
Anthropic's [client SDKs](../api/client-sdks.md) support Foundry through platform-specific packages.
...
Claude on Foundry supports most of Claude's powerful features. You can find all the features currently supported [here](./build-with-claude-overview.md).

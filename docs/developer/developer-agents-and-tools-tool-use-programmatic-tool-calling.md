...
For model compatibility and tool version details, see the [Tool reference](./developer-agents-and-tools-tool-use-tool-reference.md). Programmatic tool calling is available via the Claude API and Microsoft Foundry.
...
- Tools provided by an [MCP connector](./developer-agents-and-tools-mcp-connector.md)
...
Programmatic tool calling uses the same pricing as code execution. See the [code execution pricing](./developer-agents-and-tools-tool-use-code-execution-tool.md#usage-and-pricing) for details.
...
<CardGroup cols={2}>
  <Card title="Code Execution Tool" icon="code" href="./developer-agents-and-tools-tool-use-code-execution-tool.md">

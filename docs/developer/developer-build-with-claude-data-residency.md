...
These settings can be configured through the Console or the [Admin API](./developer-build-with-claude-administration-api.md) under the `data_residency` field.
...
This pricing applies to the Claude API (1P) only. Third-party platforms (AWS Bedrock, Google Vertex AI, Microsoft Foundry) have their own regional pricing. See the [pricing page](./developer-about-claude-pricing.md#data-residency-pricing) for details.
...
The `inference_geo` parameter is supported on the [Batch API](./developer-build-with-claude-batch-processing.md). Each request in a batch can specify its own `inference_geo` value.
...
<CardGroup>
  <Card title="Pricing" icon="dollar-sign" href="./developer-about-claude-pricing.md">
    View data residency pricing details.
  </Card>
  <Card title="Workspaces" icon="building" href="./developer-build-with-claude-workspaces.md">
    Learn about workspace configuration.
  </Card>
  <Card title="Usage and Cost API" icon="chart" href="./developer-build-with-claude-usage-cost-api.md">

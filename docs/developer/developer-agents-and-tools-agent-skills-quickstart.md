...
<Note>
For complete details on working with generated files, see the [code execution tool documentation](./developer-agents-and-tools-tool-use-code-execution-tool.md#retrieve-generated-files).
</Note>

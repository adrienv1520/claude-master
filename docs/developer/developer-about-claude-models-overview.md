...
| **[Extended thinking](./developer-build-with-claude-extended-thinking.md)** | Yes | Yes | Yes | Yes | Yes | Yes | No |
| **[Priority Tier](../api/api-service-tiers.md)** | Yes | Yes | Yes | Yes | Yes | Yes | No |

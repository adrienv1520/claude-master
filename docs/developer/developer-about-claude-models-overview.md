...
<Note>
The Max output values above apply to the synchronous Messages API. On the [Message Batches API](./developer-build-with-claude-batch-processing.md#extended-output-beta), Opus 4.6 and Sonnet 4.6 support up to 300k output tokens by using the `output-300k-2026-03-24` beta header.
</Note>

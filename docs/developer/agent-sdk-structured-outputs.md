...
The Agent SDK supports the same JSON Schema features and limitations as [API Structured Outputs](./build-with-claude-structured-outputs.md#json-schema-limitations).
...
For complete details on supported features, limitations, and regex pattern support, see [JSON Schema limitations](./build-with-claude-structured-outputs.md#json-schema-limitations) in the API documentation.

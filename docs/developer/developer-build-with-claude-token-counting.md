...
The [token counting](https://platform.claude.com/docs/en/api/messages-count-tokens.md) endpoint accepts the same structured list of inputs for creating a message, including support for system prompts, [tools](./developer-agents-and-tools-tool-use-overview.md), [images](./developer-build-with-claude-vision.md), and [PDFs](./developer-build-with-claude-pdf-support.md). The response contains the total number of input tokens.
...
### Supported models
All [active models](./developer-about-claude-models-overview.md) support token counting.
...
<Note>
[Server tool](./developer-agents-and-tools-tool-use-overview.md#server-tools) token counts only apply to the first sampling call.
</Note>
...
<Note>
See [here](./developer-build-with-claude-extended-thinking.md#how-context-window-is-calculated-with-extended-thinking) for more details about how the context window is calculated with extended thinking
...
<Note>
Token counting supports PDFs with the same [limitations](./developer-build-with-claude-pdf-support.md#pdf-support-limitations) as the Messages API.
</Note> 

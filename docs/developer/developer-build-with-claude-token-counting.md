...
<Note>
See [how the context window is calculated with extended thinking](./developer-build-with-claude-extended-thinking.md#how-context-window-is-calculated-with-extended-thinking) for more details

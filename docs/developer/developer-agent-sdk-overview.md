...
<Note>
The Claude Code SDK has been renamed to the Claude Agent SDK. If you're migrating from the old SDK, see the [Migration Guide](./developer-agent-sdk-migration-guide.md).
</Note>
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="play" href="./developer-agent-sdk-quickstart.md">
...
<Tabs>
  <Tab title="Built-in tools">
    ...
    | **[AskUserQuestion](./developer-agent-sdk-user-input.md#handle-clarifying-questions)** | Ask the user clarifying questions with multiple choice options |
  ...
  <Tab title="Hooks">
    ...
    **Available hooks:** `PreToolUse`, `PostToolUse`, `Stop`, `SessionStart`, `SessionEnd`, `UserPromptSubmit`, and more.
    ...
    [Learn more about hooks →](./developer-agent-sdk-hooks.md)
  </Tab>
  <Tab title="Subagents">
    ...
    [Learn more about subagents →](./developer-agent-sdk-subagents.md)
  </Tab>
  <Tab title="MCP">
    ...
    [Learn more about MCP →](./developer-agent-sdk-mcp.md)
  </Tab>
  <Tab title="Permissions">
    ...
    <Note>
    For interactive approval prompts and the `AskUserQuestion` tool, see [Handle approvals and user input](./developer-agent-sdk-user-input.md).
    </Note>
    ...
    [Learn more about permissions →](./developer-agent-sdk-permissions.md)
  </Tab>
  <Tab title="Sessions">
    ...
    [Learn more about sessions →](./developer-agent-sdk-sessions.md)
  </Tab>
</Tabs>
...
**Ready to build?** Follow the [Quickstart](./developer-agent-sdk-quickstart.md) to create an agent that finds and fixes bugs in minutes.
...
<Tabs>
  <Tab title="Agent SDK vs Client SDK">
    The [Anthropic Client SDK](../api/api-client-sdks.md) gives you direct API access: you send prompts and implement tool execution yourself. The **Agent SDK** gives you Claude with built-in tool execution.
...
<CardGroup cols={2}>
  ...
  <Card title="TypeScript SDK" icon="code" href="./developer-agent-sdk-typescript.md">
    Full TypeScript API reference and examples
  </Card>
  <Card title="Python SDK" icon="code" href="./developer-agent-sdk-python.md">

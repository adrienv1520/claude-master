...
| `output_format`               | [`OutputFormat`](#outputformat) ` \| None`   | `None`               | Define output format for agent results. See [Structured outputs](./agent-sdk-structured-outputs.md) for details                                                                    |
...
- [Python SDK guide](./agent-sdk-python.md) - Tutorial and examples

...
<Tip>
  For an overview of Claude 4.5's new capabilities, see [What's new in Claude 4.5](./about-claude-models-whats-new-claude-4-5.md). For migration guidance from previous models, see [Migrating to Claude 4.5](./about-claude-models-migrating-to-claude-4.md).
</Tip>
...
The [memory tool](./agents-and-tools-tool-use-memory-tool.md) pairs naturally with context awareness for seamless context transitions.
...
<Info>
  For more information on thinking capabilities, see [Extended thinking](./build-with-claude-extended-thinking.md).
</Info>

...
This guide presumes that you have already decided to use extended thinking mode and have reviewed the [extended thinking implementation guide](./developer-build-with-claude-extended-thinking.md).
...
- For workloads where the optimal thinking budget is above 32K, use [batch processing](./developer-build-with-claude-batch-processing.md) to avoid networking issues. Requests pushing the model to think above 32K tokens causes long running requests that might run up against system timeouts and open connection limits.
...
- If you need thinking below the minimum budget, use standard mode, with thinking turned off, with traditional chain-of-thought prompting with XML tags (like `<thinking>`). See [chain of thought prompting](./developer-build-with-claude-prompt-engineering-chain-of-thought.md).

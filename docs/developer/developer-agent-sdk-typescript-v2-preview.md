...
<Warning>
The V2 interface is an **unstable preview**. APIs may change based on feedback before becoming stable. Some features like session forking are only available in the [V1 SDK](./developer-agent-sdk-typescript.md).
</Warning>
...
Not all V1 features are available in V2 yet. The following require using the [V1 SDK](./developer-agent-sdk-typescript.md):
...
- [TypeScript SDK reference (V1)](./developer-agent-sdk-typescript.md) - Full V1 SDK documentation

...
- **Speed:** How quickly does the model need to respond in your application? For Claude Opus 4.6, [fast mode](./developer-build-with-claude-fast-mode.md) (research preview) can provide up to 2.5x higher output speed at premium pricing.

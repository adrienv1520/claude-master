...
- **Speed:** How quickly does the model need to respond in your application? For Claude Opus 4.6, [fast mode](./developer-build-with-claude-fast-mode.md) (beta: research preview) can provide up to 2.5x higher output speed at premium pricing.
...
1. [Create benchmark tests](./developer-test-and-evaluate-develop-tests.md) specific to your use case - having a good evaluation set is the most important step in the process
...
<CardGroup cols={3}>
  <Card title="Model comparison chart" icon="settings" href="./developer-about-claude-models-overview.md">
    See detailed specifications and pricing for the latest Claude models
  </Card>
  <Card title="What's new in Claude 4.6" icon="sparkle" href="./developer-about-claude-models-whats-new-claude-4-6.md">
    Explore the latest improvements in Claude 4.6 models
  </Card>
  <Card title="Start building" icon="code" href="../api/api-get-started.md">

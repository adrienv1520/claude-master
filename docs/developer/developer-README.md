...
**Last updated:** Thu, 22 Jan 2026 01:23:05 GMT
...
- [Tool Use | Implement Tool Use](./developer-agents-and-tools-tool-use-implement-tool-use.md)
- [Tool Use | Fine Grained Tool Streaming](./developer-agents-and-tools-tool-use-fine-grained-tool-streaming.md)
- [Tool Use | Bash Tool](./developer-agents-and-tools-tool-use-bash-tool.md)
...
- [Tool Use | Memory Tool](./developer-agents-and-tools-tool-use-memory-tool.md)
...
- [Multilingual Support](./developer-build-with-claude-multilingual-support.md)
- [Token Counting](./developer-build-with-claude-token-counting.md)
- [Embeddings](./developer-build-with-claude-embeddings.md)
- [Vision](./developer-build-with-claude-vision.md)
- [Pdf Support](./developer-build-with-claude-pdf-support.md)
- [Files](./developer-build-with-claude-files.md)
- [Search Results](./developer-build-with-claude-search-results.md)
- [Structured Outputs](./developer-build-with-claude-structured-outputs.md)
- [Skills Guide](./developer-build-with-claude-skills-guide.md)
...
- [Strengthen Guardrails | Reduce Hallucinations](./developer-test-and-evaluate-strengthen-guardrails-reduce-hallucinations.md)
- [Strengthen Guardrails | Increase Consistency](./developer-test-and-evaluate-strengthen-guardrails-increase-consistency.md)

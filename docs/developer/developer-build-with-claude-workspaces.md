...
Programmatically manage workspaces using the [Admin API](./developer-build-with-claude-administration-api.md).
...
- **Files** created via the [Files API](./developer-build-with-claude-files.md)
- **Message Batches** created via the [Batch API](./developer-build-with-claude-batch-processing.md)
- **Skills** created via the [Skills API](./developer-build-with-claude-skills-guide.md)

<Note>
Starting February 5, 2026, [prompt caches](./developer-build-with-claude-prompt-caching.md) will also be isolated per workspace (applies to the Claude API and Azure only).
</Note>
...
For detailed information on rate limits and how they work, see [Rate limits](../api/api-rate-limits.md).

## Usage and cost tracking

Track usage and costs by workspace using the [Usage and Cost API](./developer-build-with-claude-usage-cost-api.md):
...
<Steps>
  ...
  <Step title="Monitor usage">
    Use the [Usage and Cost API](./developer-build-with-claude-usage-cost-api.md) to track workspace-level consumption.
  </Step>
</Steps>
...
- [Usage and Cost API](./developer-build-with-claude-usage-cost-api.md)
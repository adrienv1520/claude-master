...
| --- | --- | --- | --- |
| Tool search | Tool definitions loaded upfront | Large toolsets (20+ tools) where most tools aren't needed every turn | [Tool search tool](./developer-agents-and-tools-tool-use-tool-search-tool.md) |
| Programmatic tool calling | `tool_result` roundtrips | Chains of tool calls that can execute as a single script | [Programmatic tool calling](./developer-agents-and-tools-tool-use-programmatic-tool-calling.md) |
| Prompt caching | Token cost of repeated tool definitions | Stable toolsets across many requests | [Tool use with prompt caching](./developer-agents-and-tools-tool-use-tool-use-with-prompt-caching.md) |
| Context editing | Old `tool_result` blocks in history | Long conversations where early results are no longer relevant | [Context editing](./developer-build-with-claude-context-editing.md) |
...
<CardGroup cols={2}>
  <Card
    ...
    href="./developer-agents-and-tools-tool-use-tool-search-tool.md"
  >
  ...
  <Card
    ...
    icon="code"
    href="./developer-agents-and-tools-tool-use-programmatic-tool-calling.md"
  >
  ...
  <Card
    ...
    icon="database"
    href="./developer-agents-and-tools-tool-use-tool-use-with-prompt-caching.md"
  >
  ...
  <Card
    ...
    icon="scissors"
    href="./developer-build-with-claude-context-editing.md"
  >

...
<Note>
This feature is **not** eligible for [Zero Data Retention (ZDR)](./developer-build-with-claude-api-and-data-retention.md). Data is retained according to the feature's standard retention policy.
</Note>
...
| Claude Sonnet 3.7 (`claude-3-7-sonnet-20250219`) ([deprecated](./developer-about-claude-model-deprecations.md)) | `code_execution_20250825` |
| Claude Haiku 4.5 (`claude-haiku-4-5-20251001`) | `code_execution_20250825` |
| Claude Haiku 3.5 (`claude-3-5-haiku-latest`) ([deprecated](./developer-about-claude-model-deprecations.md)) | `code_execution_20250825` |

<Note>
The `code_execution_20250825` version supports Bash commands and file operations. For models that support [programmatic tool calling](./developer-agents-and-tools-tool-use-programmatic-tool-calling.md), `code_execution_20260120` adds REPL state persistence and the ability to call tools from within the sandbox. A legacy version `code_execution_20250522` (Python only) is also available; see [Upgrade to latest tool version](#upgrade-to-latest-tool-version) to migrate from it.
</Note>
...
1. **Upload your file** using the [Files API](./developer-build-with-claude-files.md)
...
- **Workspace scoping**: Like [Files](./developer-build-with-claude-files.md), containers are scoped to the workspace of the API key
...
You can include the code execution tool in the [Messages Batches API](./developer-build-with-claude-batch-processing.md). Code execution tool calls through the Messages Batches API are priced the same as those in regular Messages API requests.
...
The code execution tool enables Claude to use [Agent Skills](./developer-agents-and-tools-agent-skills-overview.md). Skills are modular capabilities consisting of instructions, scripts, and resources that extend Claude's functionality.

Learn more in the [Agent Skills documentation](./developer-agents-and-tools-agent-skills-overview.md) and [Agent Skills API guide](./developer-build-with-claude-skills-guide.md).